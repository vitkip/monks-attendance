...
export default function ConstructionProjectShow({ project, transactions, statuses, filters }) {
    ...
    function submit(e) {
        ...
        if (editId) {
            form.transform((data) => ({ ...data, _method: 'put' })).post(route('construction-projects.transactions.update', [project.id, editId]), { onSuccess, preserveScroll: true, forceFormData: true });
        } else {

...
function CopyAccountButton({ account }) {
    ...
    return (
        <button
            type="button"
            onClick={handleCopy}
            className="relative inline-flex items-center gap-1 align-middle font-semibold text-slate-600 hover:text-brand-green transition-colors"
            title="ກົດເພື່ອຄັດລອກເລກບັນຊີ"
            aria-label={`ຄັດລອກເລກບັນຊີ ${account}`}
        >
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <p className="text-gray-400 text-xs mt-0.5">
                                                        ...
                                                        <CopyAccountButton account={bill.account_number} />
                                                    </p>
                                                </div>

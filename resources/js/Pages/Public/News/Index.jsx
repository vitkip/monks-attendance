...
export default function Index({ heroSlides, featured, news, categories, categorySlug, latestNews }) {
    ...
    return (
        <PublicLayout>
            <SeoHead
                title="ຂ່າວສານ ງານບຸນ ແລະ ປະກາດ"
                description="ຕິດຕາມຂ່າວສານ, ງານບຸນປະເພນີ, ປະກາດ, ການປະຕິບັດທຳ, ກຳມະຖານ, ແລະ ຄວາມເຄື່ອນໄຫວຫລ້າສຸດຂອງວັດປ່າໜອງບົວທອງໃຕ້ ນະຄອນຫຼວງວຽງຈັນ ປະເທດລາວ"
                keywords="ວັດປ່າໜອງບົວທອງໃຕ້, ວັດປ່າໜອງບົວທອງ, ຂ່າວສານວັດ, ງານບຸນ, ບຸນ, ພຣະສົງ, ພຸດທະສາສະໜາ, ປະເທດລາວ, ການປະຕິບັດທຳ, ກຳມະຖານ, ບວດຂາວ, ໄຫວ້ພຣະ, nongbuathong"
            />

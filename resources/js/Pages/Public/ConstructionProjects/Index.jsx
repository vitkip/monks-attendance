...
export default function ConstructionProjectsPublicIndex({ status, projects, statuses, totalIncomeAll, ongoingCount, featured }) {
    return (
        <PublicLayout>
            <SeoHead
                title="ໂຄງການກໍ່ສ້າງ ງານບຸນ ແລະ ການພັດທະນາ"
                description="ຕິດຕາມໂຄງການກໍ່ສ້າງ, ການຮ່ວມທຳບຸນ, ແລະ ຄວາມຄືບໜ້າການພັດທະນາ ວັດປ່າໜອງບົວທອງໃຕ້ ນະຄອນຫຼວງວຽງຈັນ ປະເທດລາວ"
                keywords="ໂຄງການກໍ່ສ້າງ, ວັດປ່າໜອງບົວທອງໃຕ້, ວັດປ່າໜອງບົວທອງ, ບຸນ, ງານບຸນ, ພຣະສົງ, ພຸດທະສາສະໜາ, ປະເທດລາວ, ການປະຕິບັດທຳ, ກຳມະຖານ, nongbuathong"
            />
